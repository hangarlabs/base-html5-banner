  ...
  var tl            = new TimelineLite(),
      ...
      function finalFrame () {
        tl.to(cloud, 0.7,{opacity: 0, y: -200},'out')
          ...
          .to(cookieOne, 1.2,{y:285, rotationZ: 110},'rain')
          .to(cookieTwo, 1.2,{y:282, rotationZ: 115},'rain+=0.5')
          .to(cookieThree, 0.7,{y:280, rotationZ: 112},'rain+=0.9')
          .to(cookieFour, 0.7,{y:290, rotationZ: 115},'rain-=0.2')
          .to(cookieFive, 0.7,{y:290, rotationZ: 180},'rain')
          .to(cookieSix, 1.2,{y:285, rotationZ: 112},'rain+=0.4')
          .to(cookieSeven, 1.2,{y:285, rotationZ: 110},'rain')
