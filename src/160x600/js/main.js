...
App_skippy.fn.step1 = function() {
  ...
  var tl            = new TimelineLite(),
        ...
        if (runShake) {
          ...
          var tween = new TimelineLite();
              tween.to(rayOne, 0.2, {x:-4, y: 4},'shake')
                   ...
                   .to(rayFour, 0.2, {x:-7, y: -4,},'shake+=0.4')

                   .to(rayFive, 0.2, {x:-4, y: 2},'shake')
                   .to(rayFive, 0.2, {x: 5, y: 5},'shake+=0.2')
                   .to(rayFive, 0.2, {x:-7, y: -4,},'shake+=0.4')

                   .to(raySix, 0.2, {x:-4, y: 2},'shake')
                   .to(raySix, 0.2, {x: 5, y: 5},'shake+=0.2')
                   .to(raySix, 0.2, {x:-7, y: -4, onComplete: rays},'shake+=0.4');
      ...
      function intro () {
         tl.from(skippySP, 0.9 ,{y: 200},'intro')
              .to(skippySP, 0.3 ,{y: 70,},'intro+=1.5')
              .from(pretzel, 0.9 ,{y: -200},'intro')
              .to(pretzel, 0.3 ,{y: -70},'intro+=1.5')
              .to(skippySP, 0.4 ,{y: -200,ease: Elastic.easeOut, onComplete: rays},'intro+=2')
              .to(pretzel, 0.4 ,{y: 200,ease: Elastic.easeOut, onComplete: shake},'intro+=2')
      ...
      function midFrame() {
        ...
        tl.to(cloudTxt, 0.5 ,{opacity: 0, scale:0},'final+=0.5')
          ...
          .to(cookie, 0.4 ,{y: -63.5},'final+=1.5')
          .to(cookieFlippedOne, 0.1,{opacity:1},'final+=1.5')
          .to(cookieFlippedOne, 0.4,{y: 57.5},'final+=1.5')
          .to([cookieFlippedOne,cookie], 0.4,{y:0, onComplete: finalFrame},'final+=2.5');


      }

      function finalFrame () {
        tl.to(cloud, 0.7,{opacity: 0, y: -200},'out')
          .to([cookieFlippedOne,cookie], 0.7,{y:400},'out')
          .from([skippyBP,skippyBPC], 0.4, {z:-100, y: 200},'pack-=0.2')
          .to([skippyBP,skippyBPC], 0.4, {opacity:1},'pack-=0.2')
          .to(cookieOne, 1.2,{y:295, rotationZ: 110},'rain')
          .to(cookieTwo, 1.2,{y:302, rotationZ: 115},'rain+=0.5')
          .to(cookieThree, 0.7,{y:290, rotationZ: 112},'rain+=0.9')
          .to(cookieFour, 1.2,{y:300, rotationZ: 115},'rain')
          .to(cookieFive, 0.7,{y:300, rotationZ: 180},'rain-=0.1')
          .to(cookieSix, 1.2,{y:295, rotationZ: 112},'rain+=0.4')
          .to(cookieSeven, 1.2,{y:295, rotationZ: 110},'rain')
          .to(rainMain, 0.4, {y:-500 ,opacity:0},'packOut+=0.9')
          .to(skippySmall, 0.4, {y:-346 ,opacity:1},'logoIntro')
          .to(logo, 0.4, {y:172 ,opacity:1},'logoIntro')
