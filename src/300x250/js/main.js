  ...
  var tl            = new TimelineLite(),
      ...
      function intro () {
         tl.from(skippySP, 0.9 ,{x: -200},'intro')
              .to(skippySP, 0.3 ,{x: -70,},'intro+=1.5')
              .from(pretzel, 0.9 ,{x: 200},'intro')
              .to(pretzel, 0.3 ,{x: 70},'intro+=1.5')
              .to(skippySP, 0.4 ,{x: 100,ease: Elastic.easeOut, onComplete: rays},'intro+=2')
              .to(pretzel, 0.4 ,{x: -100,ease: Elastic.easeOut, onComplete: shake},'intro+=2')
      ...
      function finalFrame () {
        tl.to(cloud, 0.7,{opacity: 0, y: -200},'out')
          .to([cookieFlippedOne,cookie], 0.7,{y:200},'out')
          .from([skippyBP,skippyBPC], 0.4, {z:-100, y: 200},'pack-=0.2')
          .to([skippyBP,skippyBPC], 0.4, {opacity:1},'pack-=0.2')

          .to(cookieOne, 6,{y:115, rotationZ: 110},'rain')
          .to(cookieTwo, 6,{y:100, rotationZ: 115},'rain+=0.5')
          .to(cookieThree, 0.3,{y:110, rotationZ: 112},'rain+=0.9')
          .to(cookieFour, 6,{y:120, rotationZ: 115},'rain')
          .to(cookieFive, 0.3,{y:120, rotationZ: 180},'rain+=')
          .to(cookieSix, 6,{y:115, rotationZ: 112},'rain+=0.4')
          .to(cookieSeven, 6,{y:105, rotationZ: 110},'rain')

          .to(rainMain, 0.4, {y:-200 ,opacity:0},'packOut+=0.7')
          .to(skippySmall, 0.4, {y:-152 ,opacity:1},'logoIntro')
          .to(logo, 0.4, {y:114 ,opacity:1},'logoIntro')
